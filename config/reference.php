 ...
 *     param_fetcher_listener?: Param|bool|string|array{
 *         enabled?: bool|Param, // Default: false
 ...
 *         view_response_listener?: Param|bool|string|array{
 *             enabled?: bool|Param, // Default: false
 *             force?: bool|Param, // Default: false
 *             service?: scalar|Param|null, // Default: null
 *         },
 ...
 *         array_normalizer?: Param|string|array{
 *             service?: scalar|Param|null, // Default: null
 ...
 *             priorities?: Param|string|list<scalar|Param|null>,
 *         }>,
 *         ...<string, mixed>
 *     },
 ...
 *     migrations?: array<string, list<scalar|Param|null>>,
 * }
 * @psalm-type FluxSeSyliusStripeConfig = array{
 *     line_item_image?: array{
 *         imagine_filter?: scalar|Param|null, // This is the Imagine filter used to get the image displayed on Stripe Checkout Session (default: the filter uses into `@ShopBundle/templates/product/show/page/info/overview/images.html.twig`) // Default: "sylius_shop_product_original"
 *         fallback_image?: scalar|Param|null, // Fallback image used when no image is set on a product and also when you test this plugin from a private web server (ex: from localhost) // Default: "https://placehold.co/300"
 *         localhost_pattern?: scalar|Param|null, // Stripe does not display Localhost images because it caches them on a CDN, this preg_match() pattern will allow the line item image provider to test it if the image is from a localhost network or not. // Default: "#://(localhost|127.0.0.1|[^:/]+\\.wip|[^:/]+\\.local)[:/]#"
 *     },
 * }
 ...
 *     },
 * }
 * @psalm-type SyliusAdyenConfig = array{
 *     resources?: array{
 *         adyen_reference?: array{
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Entity\\AdyenReference"
 *                 interface?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Entity\\AdyenReferenceInterface"
 *                 controller?: scalar|Param|null, // Default: "Sylius\\Bundle\\ResourceBundle\\Controller\\ResourceController"
 *                 factory?: scalar|Param|null, // Default: "Sylius\\Resource\\Factory\\Factory"
 *                 repository?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Repository\\AdyenReferenceRepository"
 *             },
 *         },
 *         shopper_reference?: array{
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Entity\\ShopperReference"
 *                 interface?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Entity\\ShopperReferenceInterface"
 *                 factory?: scalar|Param|null, // Default: "Sylius\\Resource\\Factory\\Factory"
 *                 controller?: scalar|Param|null, // Default: "Sylius\\Bundle\\ResourceBundle\\Controller\\ResourceController"
 *                 repository?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Repository\\ShopperReferenceRepository"
 *             },
 *         },
 *         log?: array{
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Entity\\Log"
 *                 interface?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Entity\\LogInterface"
 *                 factory?: scalar|Param|null, // Default: "Sylius\\Resource\\Factory\\Factory"
 *                 controller?: scalar|Param|null, // Default: "Sylius\\Bundle\\ResourceBundle\\Controller\\ResourceController"
 *                 repository?: scalar|Param|null,
 *             },
 *         },
 *         adyen_payment_detail?: array{
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Entity\\AdyenPaymentDetail"
 *                 interface?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Entity\\AdyenPaymentDetailInterface"
 *                 factory?: scalar|Param|null, // Default: "Sylius\\Resource\\Factory\\Factory"
 *                 controller?: scalar|Param|null, // Default: "Sylius\\Bundle\\ResourceBundle\\Controller\\ResourceController"
 *                 repository?: scalar|Param|null,
 *             },
 ...
 *         payment_link?: array{
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Entity\\PaymentLink"
 *                 interface?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Entity\\PaymentLinkInterface"
 *                 factory?: scalar|Param|null, // Default: "Sylius\\Resource\\Factory\\Factory"
 *                 controller?: scalar|Param|null, // Default: "Sylius\\Bundle\\ResourceBundle\\Controller\\ResourceController"
 *                 repository?: scalar|Param|null, // Default: "Sylius\\AdyenPlugin\\Repository\\PaymentLinkRepository"
 *             },
 *         },
 *     },
 *     payment_methods?: array{
 *         allowed_types?: list<scalar|Param|null>,
 *         manual_capture_supporting_types?: list<scalar|Param|null>,
 *         only_for_logged_in_users_types?: list<scalar|Param|null>,
 *         only_manual_capture_types?: list<scalar|Param|null>,
 *     },
 *     esd?: array{
 *         supported_currencies?: list<scalar|Param|null>,
 *         supported_countries?: list<scalar|Param|null>,
 *         supported_card_brands?: list<scalar|Param|null>,
 *     },
 *     integrator_name?: scalar|Param|null, // Default: "Sylius"
 * }
